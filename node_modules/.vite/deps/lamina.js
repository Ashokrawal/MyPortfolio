...
import {
  _extends,
  extend
} from "./chunk-WI6BPSQT.js";
import {
  Color,
  MathUtils,
  ShaderMaterial,
  Vector3
} from "./chunk-UPJZ5BX6.js";
import {
  require_react
...
var Abstract = class {
  ...
  getBlendMode(type, a, b) {
    if (type === BlendModes["normal"])
      return `sc_copy(${a}, ${b})`;
    else if (type === BlendModes["add"])
      return `sc_add(${a}, ${b})`;
    else if (type === BlendModes["subtract"])
      return `sc_subtract(${a}, ${b})`;
    else if (type === BlendModes["multiply"])
      return `sc_multiply(${a}, ${b})`;
    else if (type === BlendModes["addsub"])
      return `sc_addSub(${a}, ${b})`;
    else if (type === BlendModes["lighten"])
      return `sc_lighten(${a}, ${b})`;
    else if (type === BlendModes["darken"])
      return `sc_darken(${a}, ${b})`;
    else if (type === BlendModes["divide"])
      return `sc_divide(${a}, ${b})`;
    else if (type === BlendModes["overlay"])
      return `sc_overlay(${a}, ${b})`;
    else if (type === BlendModes["screen"])
      return `sc_screen(${a}, ${b})`;
    else if (type === BlendModes["softlight"])
      return `sc_softLight(${a}, ${b})`;
    else if (type === BlendModes["switch"])
      return `sc_switch(${a}, ${b})`;
  }
  getVertexVariables() {
    return "";
  }
...
var Base$1 = class extends Abstract {
  constructor(props) {
    super();
    this.name = "Base";
    this.mode = "normal";
...
var Normals$1 = class extends Abstract {
  constructor(props) {
    super();
    this.name = "Normals";
    this.mode = "normal";
...
var LayerMaterial$1 = class _LayerMaterial$1 extends ShaderMaterial {
  ...
  update() {
    if (this.layers.length) {
      Object.assign(this, _LayerMaterial$1.constructShader(this.layers));
...
var LayerMaterial = React.forwardRef(({
  children,
  ...props
}, forwardRef2) => {
  ...
  return React.createElement("layerMaterial", _extends({
    ref: react_merge_refs_esm_default([ref, forwardRef2])
  }, props), children);
});
var Base = React.forwardRef((props, forwardRef2) => {
  return React.createElement("base_", _extends({
    ref: forwardRef2
  }, props));
});
var Depth = React.forwardRef((props, forwardRef2) => {
  return React.createElement("depth_", _extends({
    ref: forwardRef2
  }, props));
});
var Fresnel = React.forwardRef((props, forwardRef2) => {
  return React.createElement("fresnel_", _extends({
    ref: forwardRef2
  }, props));
});
var Noise = React.forwardRef((props, forwardRef2) => {
  return React.createElement("noise_", _extends({
    ref: forwardRef2
  }, props));
});
var Normals = React.forwardRef((props, forwardRef2) => {
  return React.createElement("normals_", _extends({
    ref: forwardRef2
  }, props));
});
var Texture = React.forwardRef((props, forwardRef2) => {
  return React.createElement("texture_", _extends({
    ref: forwardRef2
  }, props));
});
export {
